...
const ProfilePage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'account' | 'settings' | 'notifications' | 'forecasting' | 'security' | 'members' | 'billing' | 'integrations'>('account');
  ...
  return (
    <div className="profile-page">
      ...
      <div className="profile-tabs">
        ...
        >
          {React.createElement(FiDatabase as any)} Integrations
        </button>
      </div>
